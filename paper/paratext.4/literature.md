...
- **Zhang & Yu, 2025 (GenAIECommerce Workshop)** — *Mind the Gap: Linguistic
  Divergence and Adaptation Strategies in Human-LLM Assistant vs.
  Human-Human Interactions.* arXiv:2510.02645. User-side complement to
  our model-side findings. (Verified: full author list confirmed via
  arXiv lookup for v3.)
