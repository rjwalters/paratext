...
def run_one(
    ...
    """Run the experiment for a single variant. Used by both sync and parallel paths."""
...
def new_run_id(model: str) -> str:
    """Public helper so the parallel CLI path can share one run_id across workers."""
